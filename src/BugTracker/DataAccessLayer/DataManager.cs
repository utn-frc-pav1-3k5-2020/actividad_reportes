...
public class DataManager : IDisposable
{
    ...
    public DataTable ConsultaSQLStoreProcedure(string spName, Dictionary<string, object> prs = null)
    {
        SqlCommand cmd = new SqlCommand();
        DataTable tabla = new DataTable();
        try
    ...
    public int EjecutarSQLStoreProcedure(string spName, Dictionary<string, object> prs = null)
    {
        // Se utiliza para sentencias SQL del tipo “Insert/Update/Delete”
